...
<head>
    ...
    <title>Inscription — PharmaApp</title>
...
<body style="min-height: 100vh; background: linear-gradient(135deg, #f0fdfa 0%, #f8fafc 50%, #f0f9ff 100%); display: flex; align-items: center; justify-content: center; padding: 2rem 1rem;">
    ...
    <div class="animate-fade-in-up" style="width: 100%; max-width: 480px;">
        ...
        <div style="text-align: center; margin-bottom: 2rem;">
            ...
            <h1 style="font-size: 1.75rem; font-weight: 800; color: #0f172a; margin-bottom: 0.25rem;">Créer un compte</h1>
            <p style="font-size: 0.875rem; color: #64748b;">Rejoignez PharmaApp en tant que client</p>
        </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus
                           class="input" placeholder="Marie Dupont">
                </div>

                <div>
                    <label class="label" for="email">Adresse email</label>
                    <input id="email" type="email" name="email" value="{{ old('email') }}" required
                           class="input" placeholder="marie@exemple.com">
                </div>

                <div>
                    <label class="label" for="password">Mot de passe</label>
                    <input id="password" type="password" name="password" required
                           class="input" placeholder="Au moins 8 caractères">
                </div>
        ...
        <p style="text-align: center; margin-top: 1.5rem; font-size: 0.875rem; color: #64748b;">
            Déjà un compte ?
            <a href="{{ route('login') }}" style="color: #0f766e; font-weight: 600; text-decoration: none;">
                Se connecter
            </a>
        </p>
    </div>
